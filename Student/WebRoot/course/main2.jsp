    ...
    <s:form action="insertcourse.jsp" method="post">
     <div>
    	<table id="table" width="670px" border="1" cellspacing="0"
					cellpadding="10" bordercolor="#999999">
					<br><br><br>
						<div class="tit">课程信息表</div>
    		<tr align="center">
    			<td>学号</td><td>课号</td><td>课程名</td><td>学期</td><td>学分</td><td>成绩</td><td>操作</td>
    		</tr>
    		<tbody id="pageInfo">
	    ...
	    <%
	    	session.setAttribute("number", request.getParameter("student.SNo") );
	     %>
	    		<tr align="center">
	    		<s:if test="#course[1].SNo==#session.number">
	    		
	    		<td><s:property value="#course[1].SNo"/></td>
		    		...
		    		<td><s:a href="getGrade.action?grade.SCNo=%{#course[1].SCNo}">修改</s:a>
		    		<s:a href="deleteGrade.action?grade.SCNo=%{#course[1].SCNo}" onclick="return del()">删除</s:a></td>
	    		</s:if>
	    		</tr>
